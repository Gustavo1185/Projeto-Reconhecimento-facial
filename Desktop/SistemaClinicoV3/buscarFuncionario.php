...
<!DOCTYPE html>
  ...
  <html>
    ...
    <body>  
        ...
        ?>
        <div class="col-md-9">
            <h3 class="mt-5 ml-2">Gerenciar Funcionário</h3>
                ...
                <div class="tabela rolagem">
                    <table class="table ">
                        <thead class="table-active ">
                            ...
                            $result = $s_clinico->buscaFuncionario($valorF,$buscaF);
                            if($result == null){
                            ...
                            <tbody>
                                <tr class="nQuebra">
                                    <th scope="row">
                                        <div class="form-check">
                                            <input class="form-check-input" name="check[]" type="checkbox" value="<?php echo $value->cod_funcionario;?>" id="checkTodos">
                                            <label class="form-check-label" for="defaultCheck1">
                                    ...
                                    <?php $valida= $value->cod_funcionario;?>
                              ...
                              if(isset($_POST['delete'])) {
                                ...
                                $id = $_POST["check"];
                                  foreach($id as $ids){ // Loop nas linhas via post / Pode selecionar post avontade 
                                    ...
                                    $s_clinico->deleteFuncionario($ids);
                                ...
                                <?php
                                 if(isset($_POST['editar'])) {                         
                                     $elementos = $_POST['check'];
                                      ...
                                      header('location: editarFuncionario.php?cod_funcionario=' . $elementos[0]);
