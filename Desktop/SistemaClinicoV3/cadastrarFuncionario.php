...
<!DOCTYPE html>
  <html>
    ...
    <body>   
        ...
        ?>    
        <div class="col-md-9">
            <h3 class="mt-5 ml-2">Cadastrar Funcionário</h3>
                <div class="formulario p-5">
                  <form id="formCadastrar" action="" method="post">
                      <div class="form-row">
                        <div class="form-group col-md-4">
                          <label for="inputEmail4">Código do Funcionário</label>
                          <input type="text" name="cod_funcionario" id="codigo" class="form-control" id="inputCod" placeholder="">
                        </div>
                        ...
                        <?php
                          ...
                          if(isset($_POST['enviar'])){
                            ...
                            if($senha == $repetir_senha){
                              ...
                              if($s_clinico->insert_funcionario() && $s_clinico->insert_telefone_Funcionario()){
                                ?>
